...
const listLayout: Blog[] = [
  {
    ...
    mainImage: "/images/landing/KD-BDS.png",
    linkTo: "/sp/dau-tu-kinh-doanh-bds",
    subtitle:
  ...
  },
  {
    ...
    mainImage: "/images/landing/BT-TP.png",
    subtitle: "Sản phẩm & năng lực xe máy thiết bị",
    key: "BTTP",
    linkTo: "/sp/be-tong-thuong-pham",
    _id: 2,
  },
  {
  ...
  },
  {
    ...
    mainImage: "/images/landing/XD-DUC.png",
    subtitle: "",
    key: "XDDC",
    linkTo: "/sp/xay-dung-dan-dung-va-cong-nghiep",
    _id: 5,
  },
];
